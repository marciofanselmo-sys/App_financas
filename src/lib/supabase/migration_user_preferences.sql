-- ============================================================================
-- user_preferences — preferências globais do usuário
-- ============================================================================
-- investment_pct: % padrão da receita a investir (card Investir do dashboard)
-- theme: light | dark | system (reservado)
-- default_board_id: conta padrão para novos lançamentos (reservado)
-- ============================================================================
...
-- Backfill: um registro por usuário existente
...
-- Trigger: preferências automáticas em novos cadastros

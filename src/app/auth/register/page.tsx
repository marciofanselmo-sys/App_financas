...
import {
  TrendingUp, Shield, BarChart2, CreditCard,
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-8 lg:px-16">
          <div className="w-full max-w-sm space-y-6">
            ...
            <div className="space-y-1">
              <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Crie sua conta</h2>
              <p className="text-slate-500 dark:text-slate-400 text-sm">Comece a controlar suas finanças hoje mesmo</p>
            </div>

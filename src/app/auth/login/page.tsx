      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="shadow-lg border-0 dark:bg-slate-800">
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl dark:text-slate-100">Entrar</CardTitle>
            <CardDescription className="dark:text-slate-400">Acesse sua conta para gerenciar suas finanças</CardDescription>
          </CardHeader>
